...
LS="#[fg=$G04,bg=$TC,bold] $user_icon #h #[fg=$TC,bg=$G06,nobold]$right_arrow_icon#[fg=$TC,bg=$G06] $session_icon #S "
...
#RS="#[fg=$G06,bg=$BG,nobold]$left_arrow_icon #[fg=$TC,bg=$G06] $time_icon $time_format #[fg=$TC,bg=$G06]$left_arrow_icon#[fg=$G04,bg=$TC] $date_icon $date_format "
RS="#[fg=$G06,bg=$G04]$left_arrow_icon#[fg=$TC,bg=$G06]#[fg=$TC,bg=$G06] $time_format #[fg=$TC,bg=$G06]$left_arrow_icon#[fg=$G04,bg=$TC] $date_format "
